    ...
    return (
        <div className="space-y-10 animate-fade-in py-2 pb-20">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 border-b border-white/5 pb-10">
                ...
                <button
                    type="button"
                    className="inline-flex items-center gap-3 px-8 py-4 bg-ub-gold hover:bg-ub-gold/90 text-white rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] transition-all duration-500 shadow-xl shadow-ub-gold/10 active:scale-95 group"
                >
            ...
            <form className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-[#001a33] rounded-[40px] shadow-2xl border border-white/5 p-8 space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full px-6 py-4 bg-black/20 text-white border border-white/5 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] focus:ring-2 focus:ring-ub-gold transition-all"
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                className="w-full px-6 py-4 bg-black/20 text-white border border-white/5 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] focus:ring-2 focus:ring-ub-gold transition-all resize-none"
                            ></textarea>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <select className="w-full px-6 py-4 bg-black/20 text-white border border-white/5 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] focus:ring-2 focus:ring-ub-gold transition-all appearance-none cursor-pointer">
                                    <option className="bg-[#001a33]">SELECT CATEGORY</option>
                                    <option className="bg-[#001a33]">APPAREL</option>
                                    <option className="bg-[#001a33]">ACCESSORIES</option>
                                    <option className="bg-[#001a33]">DRINKWARE</option>
                                    <option className="bg-[#001a33]">STATIONERY</option>
                                </select>
                            </div>
                            <div className="space-y-2">
                    ...
                    <div className="bg-[#001a33] rounded-[40px] shadow-2xl border border-white/5 p-8 space-y-6 relative overflow-hidden group">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/10 blur-3xl rounded-full -mr-16 -mt-16 group-hover:bg-emerald-500/20 transition-colors duration-500"></div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        type="number"
                                        placeholder="0"
                                        className="w-full pl-14 pr-6 text-white py-4 bg-black/20 border border-white/5 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] focus:ring-2 focus:ring-ub-gold transition-all"
                                    />
                                </div>
                            </div>
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        type="number"
                                        placeholder="0"
                                        className="w-full pl-14 pr-6 py-4 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] focus:ring-2 focus:ring-emerald-500 transition-all text-emerald-400 placeholder:text-emerald-700"
                                    />
                                </div>
                                <p className="text-[8px] font-bold text-gray-600 uppercase tracking-widest mt-1 ml-1">Leave empty if no discount applies.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Media Upload */}
                    <div className="bg-[#001a33] rounded-[40px] shadow-2xl border border-white/5 p-8 space-y-6">
                        <h2 className="text-sm font-black text-gray-500 uppercase tracking-[0.2em] mb-4">Product Assets</h2>
                        ...
                        <div className="border-2 border-dashed border-white/5 rounded-[32px] p-12 flex flex-col items-center justify-center hover:border-ub-gold hover:bg-white/5 transition-all cursor-pointer relative group">
                            ...
                            <p className="text-[10px] font-black text-white uppercase tracking-widest text-center">Drag & Drop or Click to Upload</p>
                            <p className="text-[8px] font-bold text-gray-600 uppercase tracking-widest mt-2 text-center">Support PNG, JPG, WEBP (Max 5MB)</p>
                        </div>
                ...
                <div className="space-y-8">
                    ...
                    {/* Meta Settings */}
                    <div className="bg-[#001a33] rounded-[40px] shadow-2xl border border-white/5 p-8 space-y-6">
                        <h2 className="text-sm font-black text-gray-500 uppercase tracking-[0.2em] mb-4">Availability</h2>
                        ...
                        <div className="space-y-4">
                            <label className="flex items-center gap-3 cursor-pointer group">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-[8px] font-bold text-gray-600 uppercase tracking-widest italic">Product will be visible to all users.</span>
                                </div>
                            </label>
                        </div>
                    </div>
