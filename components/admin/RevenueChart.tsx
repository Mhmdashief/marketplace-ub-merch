...
export default function RevenueChart() {
    ...
    return (
        <div className="bg-white rounded-[32px] shadow-sm border border-gray-100 p-8 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
                <div>
                    <h2 className="text-sm font-black text-gray-400 uppercase tracking-[0.2em] mb-1">Financial Performance</h2>
                    <h3 className="text-2xl font-black text-[#001a33] tracking-tight">Revenue Analytics</h3>
                </div>
                <div className="flex bg-gray-50 p-1.5 rounded-2xl border border-gray-100">
                    <button
                        ...
                        className={`px-6 py-2.5 text-xs font-black uppercase tracking-widest rounded-xl transition-all duration-300 ${period === 'weekly'
                                ...
                                : 'text-gray-400 hover:text-ub-navy hover:bg-white'
                            }`}
                    >
                        Weekly
                    </button>
                    <button
                        ...
                        className={`px-6 py-2.5 text-xs font-black uppercase tracking-widest rounded-xl transition-all duration-300 ${period === 'monthly'
                                ...
                                : 'text-gray-400 hover:text-ub-gold hover:bg-white'
                            }`}
                    >
                        Monthly
                    </button>
